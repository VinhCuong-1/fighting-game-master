...
export default class Fighter2 extends Sprite {
  constructor(...args) {
    ...
    this.costumes = [
      ...[0, 1, 2, 3, 4, 5].map((frame) => new Costume(`idle-${frame}`, `./assets/demon_human_sprites/demonimpmace_Animation 1_${frame}.png`, { x: 10, y: 16 })),
      ...[0, 1, 2, 3].map((frame) => new Costume(`attack-${frame}`, `./assets/demon_human_sprites/demonimpmace_attack_Animation 1_${frame}.png`, { x: 32, y: 16 })),
    ];
